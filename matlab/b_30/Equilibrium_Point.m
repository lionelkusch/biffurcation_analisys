...
function Equilibrium_Point(path,folder,nb_variable,xinit,MaxStepsize,MaxNumPoints_forward,MaxNumPoints_backward,increment,value,TestTolerance, FunTolerance, VarTolerance, InitStepsize)
