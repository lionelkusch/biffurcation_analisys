...
%             error('bad')
    ...
    dev_E = (...
                .5.*C_ee.*diff2_fe_fe(@TF_e, E+external_input_E_E, I+external_input_E_I, W_e)+...
                    C_ei.*diff2_fe_fi(@TF_e, E+external_input_E_E, I+external_input_E_I, W_e)+...
    ...
    dev_I  = (...
                .5.*C_ee.*diff2_fe_fe(@TF_i, E+external_input_I_E, I+external_input_I_I, W_i)+...
                    C_ei.*diff2_fe_fi(@TF_i, E+external_input_I_E, I+external_input_I_I, W_i)+...
    ...
    dev_c_ee = (...
                ...
                (TF_e(E+external_input_E_E, I+external_input_E_I, W_e)-E)^2+...
                 ...
                 2.*C_ei.*diff_fi(@TF_e, E+external_input_I_E, I+external_input_I_I, W_i)+...
                -2.*C_ee)./T;
            
     dev_c_ei = ((TF_e(E+external_input_E_E, I+external_input_E_I, W_e)-E).*...
                 (TF_i(E+external_input_I_E, I+external_input_I_I, W_i)-I)+...
                C_ee.*diff_fe(@TF_i, E+external_input_E_E, I+external_input_E_I, W_e)+...
                ...
                C_ii.*diff_fi(@TF_e, E+external_input_I_E, I+external_input_I_I, W_i)+...
                -2.*C_ei)./T;
